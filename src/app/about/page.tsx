    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6 text-gray-600 dark:text-gray-300">
                <p className="text-lg">
                    En <strong>A Cuanto?</strong>, queremos transformar la forma en que compras y vendes autos. Nuestra misión es centralizar la información de venta de vehículos para agilizar el proceso de publicación y venta, brindándote transparencia y claridad en cada paso.
                </p>
                <p>
